...
This README file documents the format of the `release_configurations.json` file located in this directory. The file defines Zora's release channels and provides the values used by the `zora_release.yml` GitHub workflow.
