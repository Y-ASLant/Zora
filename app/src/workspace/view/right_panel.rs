...
pub enum ReviewDestination {
    ...
    None,
    /// A Zora agent terminal is available (input box visible, not executing).
    Zap,
...
impl ReviewTerminalUnavailableReason {
    fn label(&self) -> &'static str {
        match self {
            ...
            Self::AIDisabled => "AI is disabled for Zora review destinations",
...
impl RightPanelView {
    ...
    /// considered available (non-CLI Zora terminals require AI to be on).
