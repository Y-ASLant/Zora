//! AI Assistant has since been renamed to "Zora AI" in the product.
...
pub const AI_ASSISTANT_FEATURE_NAME: &str = "Zora AI";
pub const ASK_AI_ASSISTANT_TEXT: &str = "Ask Zora AI";
