...
fn make_new_drive_menu(ctx: &AppContext) -> Menu {
    ...
    // Zora Phase 2a: removed `Share pane contents` menu item (cloud
...
fn debug_menu_items() -> Vec<MenuItem> {
    ...
    if FeatureFlag::DebugMode.is_enabled() {
        ...
        // Zora Wave 3-1:"Create anonymous user" debug menu item 随
...
/// Dispatch event to open a new Zora window
