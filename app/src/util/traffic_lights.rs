...
//! depends on the platform. The Zora app must use this information to avoid rendering UI elements
//! underneath them.
...
/// Data the Zora app needs to avoid rendering anything below the traffic lights.
#[derive(Clone, Debug)]
