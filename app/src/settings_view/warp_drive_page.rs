...
impl SettingsWidget for WarpDriveToggleWidget {
    ...
    fn search_terms(&self) -> &str {
        "zora drive tools panel command palette search workflows prompts notebooks environment variables"
    }
    ...
    fn render(
        ...
        render_body_item::<WarpDriveSettingsPageAction>(
            ...
            appearance
                ...
                .finish(),
            Some("Zora Drive is a local workspace in your terminal where you can save Workflows, Notebooks, Prompts, and Environment Variables on this device.".into()),
        )
    }
}
