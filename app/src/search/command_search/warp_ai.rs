...
const OPEN_WARP_AI_ITEM_BODY_TEXT: &str = "Ask Zora AI for command suggestions";
const TRANSLATE_WITH_WARP_AI_ITEM_BODY_TEXT: &str = "Translate into shell command using Zora AI";
...
impl SearchItem for WarpAISearchItem {
    ...
    fn render_icon(
        ...
        // Since the Zora AI logo color is hardcoded, let's find the best
    ...
    fn accessibility_label(&self) -> String {
        format!("Zora AI: {}", self.item_body_text())
    }
}

/// Zora 只保留同步入口:打开 BYOP Agent 或把自然语言写回输入框。
/// 云端“自然语言生成命令”异步源已删除。
