...
/// Returns a JS object representing the Zora Plugin API exposed to external JavaScript plugins.
///
...
/// Returns a JS object representing the Completions namespace for the Zora Plugin API.
///
/// API methods:
///
