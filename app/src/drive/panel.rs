...
/// The sidebar that houses Zora Drive.
/// `DrivePanel` is different from `DriveIndex` in that it is responsible for
/// how Zora Drive interacts with the workspace and the rest of the app, whereas
/// `DriveIndex` is the main zap drive view and responsible for the internals of Zora Drive.
...
impl DrivePanel {
    ...
    /// This functions scrolls the relevant Zora Drive item into view.
    ...
    /// This functions sets the index of a focused Zora Drive item.
