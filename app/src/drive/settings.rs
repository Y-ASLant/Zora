...
define_settings_group!(WarpDriveSettings, settings: [
    sorting_choice: WarpDriveSortingChoice {
        ...
        description: "The sort order for items in Zora Drive.",
    },
    ...
    // Controls whether Zora Drive appears in the tools panel, command palette, and command search.
    enable_warp_drive: EnableWarpDrive {
        ...
        description: "Whether Zora Drive is enabled.",
    },
]);

impl WarpDriveSettings {
    /// Returns whether Zora Drive should be considered enabled.
