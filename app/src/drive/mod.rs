...
pub struct ZapDriveObjectSettings {
    /// The folder that should be focused in the Zora Drive when the object is opened.
...
/// Enum used for sorting elements in the Zora Drive Index (and potentially other places).
...
#[schemars(
    description = "Sort order for Zora Drive items.",
