...
pub mod settings;
// Zora:删除 share_block_modal(云端 block 永久链分享)
...
// Zora:删除 ShareBlockModal pub use
...
pub fn init(app: &mut AppContext) {
    // Zora:删除 share_block_modal::init
    view::init(app);
}
...
impl SizeInfo {
    ...
    /// which comes from either a headless Zora instance or tests.
