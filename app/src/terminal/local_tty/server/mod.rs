//! Logic relating to a secondary process which Zora uses to spawn new shell
//! sessions.
//!
...
//! early during Zora's initialization, we can be more confident that there are
...
/// between processes, enabling the Zora application process to communicate
